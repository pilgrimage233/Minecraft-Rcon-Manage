...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '封禁管理表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `user`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   NOT NULL COMMENT '执行用户',
    `command`      varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '执行指令',
    `execute_time` datetime                                                       NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '执行时间',
    `response`     text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci          NULL COMMENT '执行结果',
    `status`       varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci    NULL     DEFAULT NULL COMMENT '执行状态',
    `run_time`     varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   NULL     DEFAULT NULL COMMENT '运行时间(毫秒值)',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `history_command_server_id_index` (`server_id` ASC) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 49
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '历史命令'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`          bigint                                                        NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `uuid`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '随机UUID',
    `ip`          varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'IP地址',
    `user_agent`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'UA标识',
    ...
    `city`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '地市',
    ...
    `body_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL COMMENT '请求参数',
    `remark`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
    `create_time` datetime                                                      NULL DEFAULT NULL COMMENT '创建时间',
    `update_time` datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    `create_by`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建者',
  ...
  AUTO_INCREMENT = 13
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'IP限流表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `command`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '指令',
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '公开命令表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `cmd`            varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '指令',
    `execute_server` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  NULL DEFAULT NULL COMMENT '执行服务器',
    `result`         varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '执行结果',
    `history_count`  int                                                           NULL DEFAULT NULL COMMENT '执行历史保留次数',
    `history_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL COMMENT '历史结果',
    ...
    `create_time`    datetime                                                      NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`    datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    `create_by`      varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建者',
    `update_by`      varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新者',
    `remark`         varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 4
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '定时命令'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`                            bigint                                                        NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `server_id`                     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '服务器ID',
    `online_add_whitelist_command`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '在线模式白名单添加指令',
    `offline_add_whitelist_command` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '离线模式白名单添加指令',
    `online_rm_whitelist_command`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '在线模式白名单移除指令',
    `offline_rm_whitelist_command`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '离线模式白名单移除指令',
    `online_add_ban_command`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '在线模式添加封禁指令',
    `offline_add_ban_command`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '离线模式添加封禁指令',
    `online_rm_ban_command`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '在线模式移除封禁指令',
    `offline_rm_ban_command`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '离线模式移除封禁指令',
    `easyauth`                      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否启用EasyAuthMod',
    `remark`                        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
    `create_time`                   datetime                                                      NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`                   datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    `create_by`                     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建者',
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '指令管理表'
  ROW_FORMAT = DYNAMIC;
...
VALUES (1, 103, 'admin', '若依', '00', '2873336923@qq.com', '15888888888', '1', '',
        '$2a$10$bkXwofseKfhUCYTol5Ubk.ebmzoCnseeCxqSxoGnD4AUyRxd9SUSu', '0', '0',
        '2400:e3e0:f5a9:ba68:1daf:3e5e:b3a9:6698', '2025-02-23 19:51:28', 'admin', '2023-12-26 16:54:02', '',
        '2025-02-23 19:51:28', '管理员');

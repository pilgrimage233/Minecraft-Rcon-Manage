  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="配置键" prop="configKey">
          <el-select v-model="form.configKey" placeholder="请选择配置键" style="width: 100%" filterable allow-create @change="handleConfigKeyChange">
  ...
  data() {
    return {
      ...
      configKeyOptions: [
        ...
        { key: 'question_count', label: 'question_count - 每次答题的题目数量', defaultValue: '0', description: '每次答题的题目数量' },
        ...
        { key: 'auto_passed', label: 'auto_passed - 自动审核', defaultValue: 'true', description: '自动审核', remark: '该选项打开即合格分数线自动通过审核无需管理员复审' }
      ],
      // 表单校验
      rules: {
        configKey: [

  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="100px" size="small">
      ...
      <el-form-item label="问题类型" prop="questionType">
        <el-select v-model="queryParams.questionType" clearable placeholder="请选择问题类型" size="small">
      ...
      <el-form-item label="是否必答" prop="isRequired">
        <el-select v-model="queryParams.isRequired" clearable placeholder="请选择是否必答" size="small">
    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="是否必答" prop="isRequired" width="100">
        <template slot-scope="scope">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <div v-if="form.questionType !== 4" class="answer-container">
          ...
          <el-table ref="whitelistQuizAnswer" :data="whitelistQuizAnswerList"
                    :row-class-name="rowWhitelistQuizAnswerIndex"
                    @selection-change="handleWhitelistQuizAnswerSelectionChange">
            <el-table-column align="center" type="selection" width="50"/>
            <el-table-column align="center" label="序号" prop="index" width="50"/>
            <el-table-column label="答案内容" min-width="100" prop="answerText">
              <template slot-scope="scope">
